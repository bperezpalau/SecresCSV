...
public class Main {
	...
	private void createView() {
        ...
        public static void saveTextFormat(String textFormat){
            Model.setTextFormat(textFormat);
        }
        
        public static void saveSeparator(String separator){
            Model.setSeparador(separator);
        }
        
        public static void existsHeader(boolean exists){
            Model.existsHeader(exists);
        }
}
